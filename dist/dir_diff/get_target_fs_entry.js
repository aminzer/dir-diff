...
function getTargetFsEntry(sourceFsEntry, targetRootPath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const targetFsEntryPath = path.join(targetRootPath, sourceFsEntry.relativePath);
            const targetFsEntryStats = yield (0, fs_1.stat)(targetFsEntryPath);
            if (sourceFsEntry.isFile !== targetFsEntryStats.isFile()) {
                return null;
            }
            return new models_1.FsEntry({
...
exports.default = getTargetFsEntry;
